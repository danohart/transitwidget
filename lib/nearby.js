...
/**
 * Find nearby train and bus stops for a venue lat/lon.
 * Returns structured data ready to be cached and served to the widget.
 */
export async function findNearbyStops(venueLat, venueLon) {
  ...
  // De-duplicate train stations (one station has multiple platform rows)
  ...
  // De-duplicate bus stops by name — opposite-direction stops at the same
  // intersection share a name; merge their route lists, keep nearest distance.
